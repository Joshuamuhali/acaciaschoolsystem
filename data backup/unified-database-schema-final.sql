...
-- Insert grades only if they don't exist
...
VALUES ('2026', TRUE)
ON CONFLICT (year_name) DO UPDATE SET is_active = EXCLUDED.is_active;
...
ON CONFLICT (academic_year_id, term_number) DO UPDATE SET is_active = EXCLUDED.is_active;
